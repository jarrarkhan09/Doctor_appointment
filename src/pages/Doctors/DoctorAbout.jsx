    ...
    <div>
      <div>
        ...
        <p class="text__para">
          ...
          labore aspernatur libero aperiam dolorem. Earum in, minus fugiat odit
          necessitatibus quia perspiciatis libero facere eos esse possimus
          excepturi repellat corporis?
        </p>
      </div>
          ...
          <li className="flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px]">
            <div>
              <span className="text-irisBlueColor text-[15px] leading-6 font-semibold">
                ...
                {formateDate("12-09-2002")} - {formateDate("12-04-2010")}
              </span>
